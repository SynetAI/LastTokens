// apim-1 / pkg-12 Client half（v7.2.1）— 完整单文件
    ...
    function ApiPanel({ snap, pos, onPos, onClose, theme, onTheme }) {
      ...
      const toolbar = React.createElement('div', { className: 'dsm-toolbar' },
        React.createElement('span', { className: 'dsm-toolbar-title' },
          ...
          React.createElement('span', null, '任务记录')),
        React.createElement('button', { className: 'dsm-minibtn' + (onlySession ? ' on' : ''), onClick: () => setOnlySession(!onlySession) }, '仅本会话'),
      ...
      const body = React.createElement('div', { className: 'dsm-scroll' }, rowsEl)
